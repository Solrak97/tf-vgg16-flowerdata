        ...
        <>
            <a data-bs-toggle="modal" style={{ cursor: "pointer" }} data-bs-target="#instructionsModal">
                <span data-bs-toggle="tooltip" data-bs-placement="left" title="Ayuda" data-bs-animation="true" style={{ whiteSpace: "nowrap" }}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="" class="bi bi-question-circle d-block" viewBox="0 0 16 16">
            ...
            <div class="modal fade" id="instructionsModal" tabindex="-1" aria-labelledby="einstructionsLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title fw-bold" id="instructionsLabel">Instrucciones</h5>
